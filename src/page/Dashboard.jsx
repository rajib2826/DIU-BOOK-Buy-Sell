...
const navigation = [
  ...
  { name: 'My Account', href: '/profile', icon: UsersIcon, current: 'profile' },
  {
    name: 'My Listing',
    href: '/listing',
    icon: ListBulletIcon,
  ...
  return (
    <div>
      ...
      <div className='lg:pl-56'>
        <div className='sticky top-0 z-40 lg:mx-auto lg:max-w-7xl lg:px-4'>
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <Link
                            ...
                            className={classNames(
                              active ? 'bg-gray-100' : '',
                              'block text-sm px-3 py-1 text-gray-700'
                            )}
                          >
                            Logout
                          </Link>
