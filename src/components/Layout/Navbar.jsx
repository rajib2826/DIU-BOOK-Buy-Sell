            ...
            <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
              <div className='flex h-16 items-center'>
                ...
                <div className='ml-auto flex items-center'>
                  ...
                  {/* Search */}
                  <div className='flex lg:ml-6 cursor-pointer'>
                  ...
                  <div className='flex lg:ml-6 cursor-pointer'>
                    <div
                      className='group -m-2 flex items-center p-2 text-gray-400 hover:text-gray-500'
                  ...
                  <Menu as='div' className='relative ml-3'>
                    <div>
                      <Menu.Button className='flex max-w-xs items-center rounded-full bg-white  focus:outline-none lg:rounded-md lg:p-2 lg:hover:bg-gray-50'>
                        <img
                          className='h-8 w-8 rounded-full'
                          src='https://i.ibb.co/VVVByFF/IMG-20220928-105841-01-1.jpg'
                          alt=''
                        />
